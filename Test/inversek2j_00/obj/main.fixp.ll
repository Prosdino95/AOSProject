...
; <label>:21:                                     ; preds = %20
  ...
  %23 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERi(%"class.std::basic_istream"* %22, i32* dereferenceable(4) %3)
          to label %24 unwind label %54, !taffo.constinfo !49
...
; <label>:24:                                     ; preds = %21
  ...
  br i1 %32, label %33, label %58, !taffo.initweight !25, !taffo.info !24, !taffo.target !54
...
; <label>:33:                                     ; preds = %24
  %34 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cerr, i8* getelementptr inbounds ([56 x i8], [56 x i8]* @.str.2.7, i32 0, i32 0))
          to label %35 unwind label %54, !taffo.constinfo !49
...
; <label>:35:                                     ; preds = %33
  %36 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* %34, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
          to label %37 unwind label %54, !taffo.constinfo !49
...
; <label>:54:                                     ; preds = %161, %154, %152, %144, %167, %166, %136, %132, %130, %128, %110, %86, %79, %69, %66, %35, %33, %21
...
; <label>:58:                                     ; preds = %24
  %59 = call i64 @time(i64* null) #4, !taffo.constinfo !26
  %60 = trunc i64 %59 to i32
  call void @srand(i32 %60) #4, !taffo.constinfo !26
  br label %61

; <label>:61:                                     ; preds = %77, %58
  %.08 = phi i32 [ 0, %58 ], [ %78, %77 ], !taffo.info !55
  %62 = load i32, i32* %3, align 4
  %63 = mul nsw i32 %62, 2, !taffo.constinfo !26
  %64 = mul nsw i32 %63, 2, !taffo.constinfo !26
  %65 = icmp slt i32 %.08, %64, !taffo.info !57
  br i1 %65, label %66, label %79

; <label>:66:                                     ; preds = %61
  %67 = bitcast %"class.std::basic_ifstream"* %9 to %"class.std::basic_istream"*
  %68 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERf(%"class.std::basic_istream"* %67, float* dereferenceable(4) %10)
          to label %69 unwind label %54, !taffo.initweight !58, !taffo.structinfo !59, !taffo.constinfo !49

; <label>:69:                                     ; preds = %66
  %70 = invoke dereferenceable(280) %"class.std::basic_istream"* @_ZNSirsERf(%"class.std::basic_istream"* %68, float* dereferenceable(4) %11)
          to label %71 unwind label %54, !taffo.initweight !58, !taffo.structinfo !59, !taffo.constinfo !49

; <label>:71:                                     ; preds = %69
  %72 = load float, float* %10, align 4, !taffo.initweight !58, !taffo.info !46
  %73 = sext i32 %.08 to i64, !taffo.info !10
  %.flt.s3_29fixp7 = getelementptr inbounds float, float* %31, i64 %73, !taffo.initweight !23, !taffo.info !60, !taffo.target !54
  store float %72, float* %.flt.s3_29fixp7, align 4, !taffo.info !62
  %74 = load float, float* %11, align 4, !taffo.initweight !58, !taffo.info !46
  %75 = add nsw i32 %.08, 1, !taffo.info !63, !taffo.constinfo !26
  %76 = sext i32 %75 to i64, !taffo.info !63
  %.flt.s3_29fixp1 = getelementptr inbounds float, float* %31, i64 %76, !taffo.initweight !23, !taffo.info !60, !taffo.target !54
  store float %74, float* %.flt.s3_29fixp1, align 4, !taffo.info !62
  br label %77

; <label>:77:                                     ; preds = %71
  %78 = add nsw i32 %.08, 4, !taffo.info !65, !taffo.constinfo !26
  br label %61

; <label>:79:                                     ; preds = %61
  invoke void @_ZN12AxBenchTimerC2Ev(%class.AxBenchTimer* %12)
          to label %80 unwind label %54, !taffo.constinfo !40

; <label>:80:                                     ; preds = %79
  br label %81

; <label>:81:                                     ; preds = %102, %80
  %.09 = phi i32 [ 0, %80 ], [ %103, %102 ], !taffo.info !55
  %82 = load i32, i32* %3, align 4
  %83 = mul nsw i32 %82, 2, !taffo.constinfo !26
  %84 = mul nsw i32 %83, 2, !taffo.constinfo !26
  %85 = icmp slt i32 %.09, %84, !taffo.info !57
  br i1 %85, label %86, label %104

; <label>:86:                                     ; preds = %81
  %87 = add nsw i32 %.09, 0, !taffo.info !10, !taffo.constinfo !26
  %88 = sext i32 %87 to i64, !taffo.info !10
  %89 = getelementptr inbounds float, float* %31, i64 %88, !taffo.initweight !23, !taffo.info !60, !taffo.target !54
  %90 = load float, float* %89, align 4, !taffo.initweight !25, !taffo.info !60, !taffo.target !54
  %91 = add nsw i32 %.09, 1, !taffo.info !63, !taffo.constinfo !26
  %92 = sext i32 %91 to i64, !taffo.info !63
  %93 = getelementptr inbounds float, float* %31, i64 %92, !taffo.initweight !23, !taffo.info !60, !taffo.target !54
  %94 = load float, float* %93, align 4, !taffo.initweight !25, !taffo.info !67, !taffo.target !54
  %95 = add nsw i32 %.09, 2, !taffo.info !69, !taffo.constinfo !26
  %96 = sext i32 %95 to i64, !taffo.info !69
  %97 = getelementptr inbounds float, float* %31, i64 %96, !taffo.initweight !23, !taffo.info !60, !taffo.target !54
  %98 = add nsw i32 %.09, 3, !taffo.info !71, !taffo.constinfo !26
  %99 = sext i32 %98 to i64, !taffo.info !71
  %100 = getelementptr inbounds float, float* %31, i64 %99, !taffo.initweight !23, !taffo.info !60, !taffo.target !54
  invoke void @_Z10forwardk2jffPfS_.2(float %90, float %94, float* %97, float* %100)
          to label %101 unwind label %54, !taffo.initweight !25, !taffo.info !24, !taffo.constinfo !73, !taffo.target !54, !taffo.originalCall !74

; <label>:101:                                    ; preds = %86
  br label %102

; <label>:102:                                    ; preds = %101
  %103 = add nsw i32 %.09, 4, !taffo.info !65, !taffo.constinfo !26
  br label %81
...
; <label>:105:                                    ; preds = %126, %104
  %.02 = phi i32 [ 0, %104 ], [ %127, %126 ], !taffo.info !55
  %106 = load i32, i32* %3, align 4
  %107 = mul nsw i32 %106, 2, !taffo.constinfo !26
  %108 = mul nsw i32 %107, 2, !taffo.constinfo !26
  %109 = icmp slt i32 %.02, %108, !taffo.info !57
  br i1 %109, label %110, label %128

; <label>:110:                                    ; preds = %105
  %111 = add nsw i32 %.02, 2, !taffo.info !69, !taffo.constinfo !26
  %112 = sext i32 %111 to i64, !taffo.info !69
  %113 = getelementptr inbounds float, float* %31, i64 %112, !taffo.initweight !23, !taffo.info !60, !taffo.target !54
  %114 = load float, float* %113, align 4, !taffo.initweight !25, !taffo.info !60, !taffo.target !54
  %115 = add nsw i32 %.02, 3, !taffo.info !71, !taffo.constinfo !26
  %116 = sext i32 %115 to i64, !taffo.info !71
  %117 = getelementptr inbounds float, float* %31, i64 %116, !taffo.initweight !23, !taffo.info !60, !taffo.target !54
  %118 = load float, float* %117, align 4, !taffo.initweight !25, !taffo.info !60, !taffo.target !54
  %119 = add nsw i32 %.02, 0, !taffo.info !10, !taffo.constinfo !26
  %120 = sext i32 %119 to i64, !taffo.info !10
  %121 = getelementptr inbounds float, float* %31, i64 %120, !taffo.initweight !23, !taffo.info !60, !taffo.target !54
  %122 = add nsw i32 %.02, 1, !taffo.info !63, !taffo.constinfo !26
  %123 = sext i32 %122 to i64, !taffo.info !63
  %124 = getelementptr inbounds float, float* %31, i64 %123, !taffo.initweight !23, !taffo.info !60, !taffo.target !54
  invoke void @_Z10inversek2jffPfS_.1(float %114, float %118, float* %121, float* %124)
          to label %125 unwind label %54, !taffo.initweight !25, !taffo.info !24, !taffo.constinfo !73, !taffo.target !54, !taffo.originalCall !75

; <label>:125:                                    ; preds = %110
  br label %126

; <label>:126:                                    ; preds = %125
  %127 = add nsw i32 %.02, 4, !taffo.info !65, !taffo.constinfo !26
  br label %105

; <label>:128:                                    ; preds = %105
  %129 = invoke i64 @_ZN12AxBenchTimer20nanosecondsSinceInitEv(%class.AxBenchTimer* %12)
          to label %130 unwind label %54, !taffo.constinfo !40

; <label>:130:                                    ; preds = %128
  %131 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) @_ZSt4cout, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.4.9, i32 0, i32 0))
          to label %132 unwind label %54, !taffo.constinfo !49

; <label>:132:                                    ; preds = %130
  %133 = uitofp i64 %129 to double
  %134 = fdiv double %133, 1.000000e+09, !taffo.constinfo !76
  %135 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEd(%"class.std::basic_ostream"* %131, double %134)
          to label %136 unwind label %54, !taffo.constinfo !49

; <label>:136:                                    ; preds = %132
  %137 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %135, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5.10, i32 0, i32 0))
          to label %138 unwind label %54, !taffo.constinfo !49

; <label>:138:                                    ; preds = %136
  br label %139

; <label>:139:                                    ; preds = %164, %138
  %.01 = phi i32 [ 0, %138 ], [ %165, %164 ], !taffo.info !55
  %140 = load i32, i32* %3, align 4
  %141 = mul nsw i32 %140, 2, !taffo.constinfo !26
  %142 = mul nsw i32 %141, 2, !taffo.constinfo !26
  %143 = icmp slt i32 %.01, %142, !taffo.info !57
  br i1 %143, label %144, label %166

; <label>:144:                                    ; preds = %139
  %145 = bitcast %"class.std::basic_ofstream"* %8 to %"class.std::basic_ostream"*
  %146 = add nsw i32 %.01, 0, !taffo.info !10, !taffo.constinfo !26
  %147 = sext i32 %146 to i64, !taffo.info !10
  %.flt.s3_29fixp = getelementptr inbounds float, float* %31, i64 %147, !taffo.initweight !23, !taffo.info !60, !taffo.target !54
  %.flt = load float, float* %.flt.s3_29fixp, align 4, !taffo.initweight !25, !taffo.info !60, !taffo.target !54
  %148 = fmul float 0x41C0000000000000, %.flt, !taffo.info !60, !taffo.target !54
  %.flt.fallback.s3_29fixp = fptosi float %148 to i32, !taffo.info !60, !taffo.target !54
  %149 = sitofp i32 %.flt.fallback.s3_29fixp to float, !taffo.info !60, !taffo.target !54
  %150 = fdiv float %149, 0x41C0000000000000, !taffo.info !60, !taffo.target !54
  %151 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* %145, float %150)
          to label %152 unwind label %54, !taffo.initweight !27, !taffo.structinfo !26, !taffo.constinfo !49, !taffo.target !54

; <label>:152:                                    ; preds = %144
  %153 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %151, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i32 0, i32 0))
          to label %154 unwind label %54, !taffo.initweight !31, !taffo.structinfo !26, !taffo.constinfo !49, !taffo.target !54

; <label>:154:                                    ; preds = %152
  %155 = add nsw i32 %.01, 1, !taffo.info !63, !taffo.constinfo !26
  %156 = sext i32 %155 to i64, !taffo.info !63
  %.flt.s3_29fixp4 = getelementptr inbounds float, float* %31, i64 %156, !taffo.initweight !23, !taffo.info !60, !taffo.target !54
  %.flt12 = load float, float* %.flt.s3_29fixp4, align 4, !taffo.initweight !25, !taffo.info !60, !taffo.target !54
  %157 = fmul float 0x41C0000000000000, %.flt12, !taffo.info !60, !taffo.target !54
  %.flt12.fallback.s3_29fixp = fptosi float %157 to i32, !taffo.info !60, !taffo.target !54
  %158 = sitofp i32 %.flt12.fallback.s3_29fixp to float, !taffo.info !60, !taffo.target !54
  %159 = fdiv float %158, 0x41C0000000000000, !taffo.info !60, !taffo.target !54
  %160 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZNSolsEf(%"class.std::basic_ostream"* %153, float %159)
          to label %161 unwind label %54, !taffo.initweight !27, !taffo.structinfo !26, !taffo.constinfo !49, !taffo.target !54

; <label>:161:                                    ; preds = %154
  %162 = invoke dereferenceable(272) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* dereferenceable(272) %160, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i32 0, i32 0))
          to label %163 unwind label %54, !taffo.initweight !31, !taffo.structinfo !26, !taffo.constinfo !49, !taffo.target !54

; <label>:163:                                    ; preds = %161
  br label %164

; <label>:164:                                    ; preds = %163
  %165 = add nsw i32 %.01, 4, !taffo.info !65, !taffo.constinfo !26
  br label %139

; <label>:166:                                    ; preds = %139
  invoke void @_ZNSt14basic_ifstreamIcSt11char_traitsIcEE5closeEv(%"class.std::basic_ifstream"* %9)
          to label %167 unwind label %54, !taffo.constinfo !40

; <label>:167:                                    ; preds = %166
  invoke void @_ZNSt14basic_ofstreamIcSt11char_traitsIcEE5closeEv(%"class.std::basic_ofstream"* %8)
          to label %168 unwind label %54, !taffo.constinfo !40

; <label>:168:                                    ; preds = %167
  %169 = bitcast float* %31 to i8*, !taffo.initweight !23, !taffo.info !79, !taffo.target !54
  call void @free(i8* %169) #4, !taffo.initweight !25, !taffo.info !24, !taffo.constinfo !26, !taffo.target !54
  br label %170

; <label>:170:                                    ; preds = %168, %37
  %.0 = phi i32 [ -1, %37 ], [ 0, %168 ], !taffo.info !80
  call void @_ZNSt14basic_ifstreamIcSt11char_traitsIcEED1Ev(%"class.std::basic_ifstream"* %9) #4, !taffo.constinfo !26
...
; <label>:172:                                    ; preds = %171, %46
  %.15 = phi i32 [ %.04, %171 ], [ %49, %46 ]
  %.1 = phi i8* [ %.03, %171 ], [ %48, %46 ]
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %6) #4, !taffo.constinfo !26
  br label %173

; <label>:173:                                    ; preds = %172, %42
  %.26 = phi i32 [ %.15, %172 ], [ %45, %42 ]
  %.2 = phi i8* [ %.1, %172 ], [ %44, %42 ]
  call void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED1Ev(%"class.std::__cxx11::basic_string"* %4) #4, !taffo.constinfo !26
  br label %174

; <label>:174:                                    ; preds = %173, %38
  %.37 = phi i32 [ %.26, %173 ], [ %41, %38 ]
  %.3 = phi i8* [ %.2, %173 ], [ %40, %38 ]
  %175 = insertvalue { i8*, i32 } undef, i8* %.3, 0
  %176 = insertvalue { i8*, i32 } %175, i32 %.37, 1
  resume { i8*, i32 } %176
}
